...
--
-- Host: 127.0.0.1
-- Generation Time: 12-Set-2014 às 15:16
...
(11, 'wowslider/3cdca4c4f4ebedaa59c686d2bd4febdc.jpg', '2014-08-07 15:06:48', 'test 22', '', 5, NULL, '2014-08-07 15:07:00', '2014-08-07 15:10:00'),
(12, 'wowslider/779380130d2b48034f97b26f7f288145.jpg', '2014-08-16 19:31:18', 'Ronaldo test', '#', 5, NULL, '2014-08-16 19:32:30', '2014-08-16 19:35:30');
...
--
-- Indexes for table `etec_categoria`
--
ALTER TABLE `etec_categoria`
 ADD PRIMARY KEY (`ca_codigo`);

--
-- Indexes for table `etec_grupo`
--
ALTER TABLE `etec_grupo`
 ADD PRIMARY KEY (`g_codigo`), ADD KEY `g_privilegio` (`g_privilegio`);

--
-- Indexes for table `etec_integra`
--
ALTER TABLE `etec_integra`
 ADD PRIMARY KEY (`in_codigo`), ADD KEY `in_categoria` (`in_categoria`);

--
-- Indexes for table `etec_pagina`
--
ALTER TABLE `etec_pagina`
 ADD PRIMARY KEY (`pa_codigo`);

--
-- Indexes for table `etec_privilegio`
--
ALTER TABLE `etec_privilegio`
 ADD PRIMARY KEY (`p_codigo`);

--
-- Indexes for table `etec_relatorio`
--
ALTER TABLE `etec_relatorio`
...
ALTER TABLE `etec_usuario`
 ADD PRIMARY KEY (`u_codigo`), ADD KEY `u_grupo` (`u_grupo`);

--
-- Indexes for table `etec_wowslide`
--
ALTER TABLE `etec_wowslide`
 ADD PRIMARY KEY (`w_codigo`);
...
--
-- AUTO_INCREMENT for table `etec_categoria`
--
ALTER TABLE `etec_categoria`
MODIFY `ca_codigo` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `etec_grupo`
--
ALTER TABLE `etec_grupo`
MODIFY `g_codigo` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `etec_integra`
--
ALTER TABLE `etec_integra`
MODIFY `in_codigo` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `etec_pagina`
--
ALTER TABLE `etec_pagina`
MODIFY `pa_codigo` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=31;
--
-- AUTO_INCREMENT for table `etec_privilegio`
--
ALTER TABLE `etec_privilegio`
MODIFY `p_codigo` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `etec_relatorio`
--
ALTER TABLE `etec_relatorio`
MODIFY `r_codigo` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=30;
--
-- AUTO_INCREMENT for table `etec_usuario`
--
ALTER TABLE `etec_usuario`
MODIFY `u_codigo` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `etec_wowslide`
--
ALTER TABLE `etec_wowslide`
MODIFY `w_codigo` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
